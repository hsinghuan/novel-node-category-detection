...
class LabelPropPU(L.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        ap = average_precision_score(y_oracle[tgt_val_mask], scores[tgt_val_mask])
        f1 = f1_score(y_oracle[tgt_val_mask], (scores > 0.5).astype(int)[tgt_val_mask])
    ...
    def on_test_epoch_end(self):
        ...
        ap = average_precision_score(y_oracle[tgt_test_mask], scores[tgt_test_mask])
        f1 = f1_score(y_oracle[tgt_test_mask], (scores > 0.5).astype(int)[tgt_test_mask])
        ...
        tgt_ap = average_precision_score(y_oracle[tgt_mask], scores[tgt_mask])
        tgt_f1 = f1_score(y_oracle[tgt_mask], (scores > 0.5).astype(int)[tgt_mask])
